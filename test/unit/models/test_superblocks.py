...
def go_list_proposals():
    items = [
        ...
        {u'AbsoluteYesCount': 1000,
         ...
         u'DataString': u'[["proposal", {"end_epoch": 2122520400, "name": "fernandez-7625", "payment_address": "mocfCW5mUWLdcqphNxbcsVKjzqTgdKckW6", "payment_amount": 32.01, "start_epoch": 1474261086, "type": 1, "url": "http://terracoincentral.org/fernandez-7625"}]]',
